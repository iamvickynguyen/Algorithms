# input: n, m; n: number of nodes, m: number of edges. Then follow m lines, each line consisting of u, v and w indicating that there is an edge between u and v in the graph with weight w
# 4 4
# 0 1 1
# 1 2 2
# 1 3 3
